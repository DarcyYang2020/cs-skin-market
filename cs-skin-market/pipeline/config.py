...
PARAM_REGIME = {
    ...
    "param_history": [
        ...
        "rise_contract v6 候选族注册（2026-08-16，默认关 CS_ENGINE_RISE_CONTRACT）：合纵型深收缩慢涨（sc30≤-10+s7≤0.85s30+3<chg7≤15+TH≥55+pct>40，priority 27/limit 0.05）。池级格 fit +1.86/val +19.17 四类买涨结构唯一 fit/val 双正；重放 362 信号（+127/0）发射侧 normal fit p_avg=0.0；组合级唯一过三关配置=全部 hold21（+10.33pp/+2.49pp 回撤）但需撤销 rise 跟踪止损 → 登记候选不 bump，用户决策表与按族分类退出计划见 decision-log 2026-08-16 条目 M",
