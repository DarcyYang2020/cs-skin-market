...
- 口径：基于 data/item_backtest_latest.json（run_item_backtest.py --all 产物，与快照 item_backtest_20260803.json 同一份数据），88 条 buy 信号，2025-11-15 ~ 2026-06-21；之后市场反弹未再触发 buy，不需重放全量引擎。
...
完整明细见 data/methodology_report.json（聚类报告 / 事件级统计 / walk-forward / 置换检验 四块）。
