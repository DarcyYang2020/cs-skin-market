...
- **保留策略（2026-08-09 落地，2026-08-13 补 market_snapshot，2026-08-16 大盘五时期更新，2026-08-20 price_history/monitor_events 放长至 3 年；`pipeline/db.py:run_retention_cleanup`）**: price_history **1095 天**（3 年，2026-08-20 用户指令：与回放库 3 年窗口对齐，历史已从回放库回填，决策见 decision-log CV）；monitor_events **1095 天**（3 年，2026-08-20 PM 裁定：研究价值数据，J-2 A 通道/事件级验证依赖历史事件，决策见 decision-log CV）；snapshots / market_snapshot 365 天；market_index 1095 天（3 年，五时期长周期轴 chg180 需要，2026-08-16 已一次性回填至 2023-11-17 起，脚本 `references/backfill_market_index_3y.py`）；scan_*.md 旧报告 90 天；进度文件（scan_progress_*/discover_progress_*）7 天；scan_history JSON 保留最近 30 份；monitor_rank_snapshot 为研究型积累不清理。清理由批量扫描收尾与每日任务自动执行（含 VACUUM）；台账与备份按各自规则。
