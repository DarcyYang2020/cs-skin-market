...
- **依赖**：D5/D6（不变量 + oos_zone）。**负责**：②研究。**状态**：**已解冻（判据冻结 DD，②实现中·仅 fit 段）**。
...
- **依赖**：D6（oos_zone）、R1（因子基础）。**负责**：②研究。**状态**：判据已交付（2026-08-27，decision-log DP，references/r3-family-isolation-prereg-2026-08-27.md），待 PM 冻结后执行 6 族隔离评估。
...
- **依赖**：D2（点差派生）、R1。**负责**：②研究。**状态**：判据已交付（2026-08-27，decision-log DP，references/r5-emotion-v0-prereg-2026-08-27.md），待 PM 冻结后执行 v0 情绪评估。
