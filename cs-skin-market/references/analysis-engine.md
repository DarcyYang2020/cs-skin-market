...
触发均记录到 `deduction_sources`（market_weak_filter / greedy_no_buy / halfway_downgrade / buy_cluster_dedup / falling_knife_filter），前端可追溯降级原因。

回测（2025-11-02 起, warmup=30）: 67 信号（含重复）→ 16 独立信号；14d 胜率 61%→81%（均+17.1%），30d 77%→69%（均+28.9%，剔除半山腰、贪婪、飞刀等负期望区）。
...
- **P0 过滤后（2026-08-01）**: 16 独立信号, 14d 胜率 81% / 均+17.1%, 30d 胜率 69% / 均+28.9%（含飞刀确认过滤）
- 旧版（含重复）: 67 信号, 14d 61% / 均+15.7%, 30d 77% / 均+29.3%

| 文件 | 说明 |
|---|---|
| run_item_backtest.py | 单品离线回放, warmup=30: 67信号→16 独立, 14d胜率81%/均+17.1%, 30d胜率69%/均+28.9% (2026-05-21~07-31) |
