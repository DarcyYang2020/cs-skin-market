# 决策日志 · 历史归档卷（2026-08-18 DOC-COMPACT-1）

> 本卷为 `references/decision-log.md` 的历史决策全文（2026-08-03 ~ 2026-08-18 至 AL 距买点探针）。
> 主文件（保留最新战役 AM~AZ + 归档索引）见 `references/decision-log.md`。
> 口径单一事实源：`references/terminology.md` + `pipeline/config.py:BASELINE_LEDGER`。
> 历史账本原文不改（含旧口径仅代表当时判断），当前基线以 terminology/config 为准。
