...
### 建仓区域假底部过滤 (V5, 2026-08-01)
「建仓区域」buy（pct≤30 + TH≥55 + z≤0）需满足深跌确认：**30日跌幅≤-20% 或 14日跌幅≤-10%**，否则降级「🟡 假底部·观望」
- 数据验证 (2025-11-02起, run_backtest.py): 过滤后 buy 6次, 14d/30d 胜率 100%, 均收益 +29.7%（原 14 信号: 14d 86% / 30d 57%）
- 拦截样本: 2026-02 六连发（30d -0.6%~-3.6%）、06-15（-5.7%）、06-30（-7.0%）均为假底部
...
- 回测（2025-11-02 起, warmup=30）: 67信号 → 16 独立信号, 14d 胜率 81%（均+17.1%）, 30d 胜率 69%（均+28.9%）
...
- warmup=30 结果（2026-05-21~07-31, P0 过滤后 16 信号）: 14d胜率81%/均+17.1%, 30d胜率69%/均+28.9%（旧版 67 信号含重复: 14d 61%/30d 77%）
