path = r'C:\Users\81572\Desktop\codex\cs-model\cs-skin-market\pipeline\supply.py'
content = '''"""
...
def analyze_supply(prices, num_data, vol_total, item_meta=None):
    ...
    if item_meta:
        ...
        if rarity == "\\u9690\\u79d8" and type_name not in ("\\u5200", "\\u624b\\u5957"):
